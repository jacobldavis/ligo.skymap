...
def bayestar_smtps_pixel(integrators, nint, uniq, value, gmst, nifos, nsamples, sample_rate,
    ...
    # accum = vmap(lambda iint: vmap(lambda itwopsi: vmap(lambda iu: vmap(lambda isample: u_points_weights[iu][1] + log_radial_integrator_quadax.log_radial_integrator_eval_quadax()))))
