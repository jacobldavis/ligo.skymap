...
from ligo.skymap.jaxcore.moc import nest2uniq64, uniq2nest64, uniq2ang64

# --- TEST SUITE ---


@pytest.mark.parametrize("order, nest, uniq", [
    (0, 0, 4),
    (0, 1, 5),
    (0, 2, 6),
    (0, 3, 7),
    ...
    (12, 0, 0x4000000),
    (12, 1, 0x4000001),
    (29, 0, 0x1000000000000000),
    (29, 1, 0x1000000000000001),
    (29, 0x2FFFFFFFFFFFFFFF, 0x3FFFFFFFFFFFFFFF),
])
